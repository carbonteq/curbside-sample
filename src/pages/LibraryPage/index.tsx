            ...
            <Tooltip key={vt.id} title={vt.label}>
              <IconButton
                ...
                sx={(t) => ({
                  ...
                  boxShadow: view === vt.id ? t.shadows[t.elevation.low] : 'none',
                  transition: t.motion.short,
        ...
        return (
          <Box
            ...
            sx={(t) => ({
              ...
              position: 'relative',
              transition: t.motion.short,
              boxShadow: isSelected ? t.shadows[t.elevation.low] : 'none',
              '&:hover': { borderColor: isSelected ? t.palette.primary.main : t.border.strong, boxShadow: t.shadows[t.elevation.low] },
